    ...
    describe('next day', function () {
        context('normal Items', function () {
            ...
            it('updates normal items with a quality of 0', function () {
                $gr = new GildedRose((new MockItemFactory())->itemWithRules('normal', 0, 5));
                $gr->nextDay();
        ...
        context('Sulfuras Items', function () {
            it('updates Sulfuras items before the sell date', function () {
                $gr = new GildedRose(
                    (new MockItemFactory())->itemWithRules('Sulfuras, Hand of Ragnaros', 10, 5)
                );
                $gr->nextDay();
            ...
            it('updates Sulfuras items after the sell date', function () {
                $gr = new GildedRose(
                    (new MockItemFactory())->itemWithRules('Sulfuras, Hand of Ragnaros', 10, -1)
                );
                $gr->nextDay();
                expect($gr->getItem(0)->quality)->toBe(10);
                expect($gr->getItem(0)->sellIn)->toBe(-1);
        ...
        context('Backstage Passes', function () {
            it('updates Backstage pass items long before the sell date', function () {
                $gr = new GildedRose(
                    (new MockItemFactory())->itemWithRules('Backstage passes to a TAFKAL80ETC concert', 10, 11)
                );
                $gr->nextDay();
                expect($gr->getItem(0)->quality)->toBe(11);
            ...
            it('updates Backstage pass items close to the sell date', function () {
                $gr = new GildedRose(
                    (new MockItemFactory())->itemWithRules('Backstage passes to a TAFKAL80ETC concert', 10, 10)
                );
                $gr->nextDay();
                expect($gr->getItem(0)->quality)->toBe(12);
            ...
            it('updates Backstage pass items close to the sell data, at max quality', function () {
                $gr = new GildedRose(
                    (new MockItemFactory())->itemWithRules('Backstage passes to a TAFKAL80ETC concert', 50, 10)
                );
                $gr->nextDay();
                expect($gr->getItem(0)->quality)->toBe(50);
                expect($gr->getItem(0)->sellIn)->toBe(9);
            ...
            it('updates Backstage pass items very close to the sell date', function () {
                $gr = new GildedRose(
                    (new MockItemFactory())->itemWithRules('Backstage passes to a TAFKAL80ETC concert', 10, 5)
                );
                $gr->nextDay();
                expect($gr->getItem(0)->quality)->toBe(13); // goes up by 3
                expect($gr->getItem(0)->sellIn)->toBe(4);
            });
            it('updates Backstage pass items very close to the sell date in last 5 day range', function () {
                $gr = new GildedRose(
                    (new MockItemFactory())->itemWithRules('Backstage passes to a TAFKAL80ETC concert', 10, 1)
                );
                $gr->nextDay();
                expect($gr->getItem(0)->quality)->toBe(13); // goes up by 3
            ...
            it('updates Backstage pass items very close to the sell date, at max quality', function () {
                $gr = new GildedRose(
                    (new MockItemFactory())->itemWithRules('Backstage passes to a TAFKAL80ETC concert', 50, 5)
                );
                $gr->nextDay();
                expect($gr->getItem(0)->quality)->toBe(50);
                expect($gr->getItem(0)->sellIn)->toBe(4);
            ...
            it('updates Backstage pass items with one day left to sell, at max quality', function () {
                $gr = new GildedRose(
                    (new MockItemFactory())->itemWithRules('Backstage passes to a TAFKAL80ETC concert', 50, 1)
                );
                $gr->nextDay();
                expect($gr->getItem(0)->quality)->toBe(50);
                expect($gr->getItem(0)->sellIn)->toBe(0);
            ...
            it('updates Backstage pass items on the sell date', function () {
                $gr = new GildedRose(
                    (new MockItemFactory())->itemWithRules('Backstage passes to a TAFKAL80ETC concert', 10, 0)
                );
                $gr->nextDay();
                expect($gr->getItem(0)->quality)->toBe(0);
                expect($gr->getItem(0)->sellIn)->toBe(-1);
        ...
        context("Conjured Items", function () {
            it('updates Conjured items before the sell date', function () {
                $gr = new GildedRose(
                    (new MockItemFactory())->itemWithRules('Conjured Mana Cake', 10, 10)
                );
                $gr->nextDay();
                expect($gr->getItem(0)->quality)->toBe(8);
                expect($gr->getItem(0)->sellIn)->toBe(9);
            ...
            it('updates Conjured items at zero quality', function () {
                $gr = new GildedRose(
                    (new MockItemFactory())->itemWithRules('Conjured Mana Cake', 0, 10)
                );
                $gr->nextDay();
                expect($gr->getItem(0)->quality)->toBe(0);
                expect($gr->getItem(0)->sellIn)->toBe(9);
            ...
            it('updates Conjured items on the sell date', function () {
                $gr = new GildedRose(
                    (new MockItemFactory())->itemWithRules('Conjured Mana Cake', 10, 0)
                );
                $gr->nextDay();
            ...
            it('updates Conjured items on the sell date at 0 quality', function () {
                $gr = new GildedRose(
                    (new MockItemFactory())->itemWithRules('Conjured Mana Cake', 0, 0)
                );
                $gr->nextDay();
                expect($gr->getItem(0)->quality)->toBe(0);
                expect($gr->getItem(0)->sellIn)->toBe(-1);
